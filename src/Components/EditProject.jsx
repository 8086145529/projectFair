...
function EditProject({project}) {
  ...
  useEffect(()=>{
    if(projectDetails.projectImage){
      setPreview(URL.createObjectURL(projectDetails.projectImage))//URL is a class in javascript object and createObjectURL is a method in URL.it is used to convert the filename to path
    }
          ...
          <div className='row'>
            <div className='col-lg-6'>
              ...
              <label>
                ...
                <img className='img-fluid' height={'200px'} src={preview?preview:`${BASE_URL}/uploads/${project.projectImage}`} alt="" />
              </label>
            </div>
            <div className=' col-lg-6'>
              <div className='mb-3'>
              ...
              <div className='mb-3'>
                <input value={projectDetails.languages} onChange={e=>setProjectDetails({...projectDetails,languages:e.target.value})} type="text" className='form-control' placeholder='Language Used'   />
              </div>
              <div className='mb-3'>
                <input value={projectDetails.github}  onChange={e=>setProjectDetails({...projectDetails,languages:e.target.value})} type="text" className='form-control' placeholder='Github Link'  />
              </div>
              <div className='mb-3'>
